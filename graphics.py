...
The library provides the following graphical objects:
    ...
    Polygon
    Text
    TextRect (a rectangle with a text element)
...
class TextRect:
   ...
   ## Rectangle-affecting methods
   def getP1(self):
      return self._rect.getP1()

   def getP2(self):
      return self._rect.getP2()
   ...
   def getTextAnchor(self):
      return self._text.getAnchor()

   def setTextFace(self, face):
      self._text.setFace(face)
   ...
   def __repr__(self):
        return "TextRect[({}, {}), '{}']".format(str(self._rect.getP1()), \
                                                 str(self._rect.getP2()), \
                                                 self._text.getText())
